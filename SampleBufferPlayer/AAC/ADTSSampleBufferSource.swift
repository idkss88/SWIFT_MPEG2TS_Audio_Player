...
class ADTSSampleBufferSource : TSDemuxDelegate {
    ...
    init(fromOffset offset: CMTime) {
        ...
        demuxer!.downloader!.ip = "233.15.200.52"
    ...
    */
    ...
    public func buildSampleBuffer(framePos:Int, frameCount:Int, presentationTimeStamp:CMTime) -> CMSampleBuffer? {
        ...
        var sampleBuffer:CMSampleBuffer?
        print(self.adtsData!.subdata(in: dataOffset..<dataOffset+dataSize).bytes)
