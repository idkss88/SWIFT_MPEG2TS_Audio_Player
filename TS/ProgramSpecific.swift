...
class ProgramSpecific: PSIPointer, PSITableHeader, PSITableSyntax {
    ...
    func arrayOfPackets(_ PID: UInt16) -> [PartialTSPacket] {
    ...
    override var tableData: Data {
        ...
        set {
            ...
            do {
                ...
                print("Error ProgramAssociationSpecific")
            }
        }
    }
}
    ...
    override var tableData: Data {
        ...
        set {
            ...
            do {
                ...
                print("Error ProgramMapSpecific")
            }
        }
    }
}
