...
public class Parser: Parsing {
    //public var packets: [(Data, AudioStreamPacketDescription?, CMTime, ADTSHeader?)]
    ...
    static private var instance: Parser? = try? Parser()
    ...
    public internal(set) var cookie: [CChar]?
   // public internal(set) var magic: UnsafeMutablePointer<CChar>?
    public internal(set) var magicSize: UInt32?
    public internal(set) var audioChannelLayout: [CChar]?
    public internal(set) var audioChannelLayoutSize: UInt32?
    public internal(set) var recvTimetable =  [CMTime]()
    public internal(set) var callbackCnt: Int = 0
    
    public internal(set) var packets = [(Data, AudioStreamPacketDescription?, CMTime, AC3Info?)]()
    ...
    public init() throws {
        ...
        guard AudioFileStreamOpen(context, ParserPropertyChangeCallback, ParserPacketCallback, kAudioFileAAC_ADTSType
    ...
    public func parse(data: Data, time: CMTime) throws {
